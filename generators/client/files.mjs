...
const ANGULAR_DIR = `${CLIENT_MAIN_SRC_DIR}app/`;
  ...
  layoutFiles: [
    {
      templates: [
        {
          file: `common/${CLIENT_MAIN_SRC_DIR}content/images/jhipster_family_member_4.svg`,
          noEjs: true,
          renameTo: () => `${CLIENT_MAIN_SRC_DIR}content/images/jhipster_family_member_4.svg`,
        },
        {
          file: `common/${CLIENT_MAIN_SRC_DIR}content/images/jhipster_family_member_4_head-192.png`,
          noEjs: true,
          renameTo: () => `${CLIENT_MAIN_SRC_DIR}content/images/jhipster_family_member_4_head-192.png`,
        },
        {
          file: `common/${CLIENT_MAIN_SRC_DIR}content/images/jhipster_family_member_4_head-256.png`,
          noEjs: true,
          renameTo: () => `${CLIENT_MAIN_SRC_DIR}content/images/jhipster_family_member_4_head-256.png`,
        },
        {
          file: `common/${CLIENT_MAIN_SRC_DIR}content/images/jhipster_family_member_4_head-384.png`,
          noEjs: true,
          renameTo: () => `${CLIENT_MAIN_SRC_DIR}content/images/jhipster_family_member_4_head-384.png`,
        },
        {
          file: `common/${CLIENT_MAIN_SRC_DIR}content/images/jhipster_family_member_4_head-512.png`,
          noEjs: true,
          renameTo: () => `${CLIENT_MAIN_SRC_DIR}content/images/jhipster_family_member_4_head-512.png`,
        },
      ],
    },
  ],
  ...
  reactMain: [
    {
      ...
      templates: [
        /*
        {
          ...
          renameTo: () => `${CLIENT_MAIN_SRC_DIR}manifest.webapp`,
        },
        {
